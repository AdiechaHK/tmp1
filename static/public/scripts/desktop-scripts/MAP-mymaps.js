...
var STYLES = STYLES_color, STYLES_googleDefault=[];
var pos = default_pos
var mapOptions = {
    zoom: 1,
    center: pos,
    scaleControl: true, /*zoomControlOptions: {style: google.maps.ZoomControlStyle.SMALL, position: google.maps.ControlPosition.RIGHT_BOTTOM },*/
    zoomControl: false,// to use custome zoom
    fullscreenControl: true,            
    enableCloseButton: true,
    mapTypeControl: false,//streetViewControl: false,
    disableDefaultUI: false,
    streetViewControl: true, /*streetViewControlOptions: {enableCloseButton:true, position: google.maps.ControlPosition.RIGHT_CENTER },*/
