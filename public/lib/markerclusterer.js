...
function parsePosition(mapUrl){
  var posindex = mapUrl.indexOf("ll=")
  var lastindex = mapUrl.indexOf('&z=')
  var posVal = mapUrl.substring(posindex+3, lastindex).split(',');
  console.log(posVal);
  return posVal;
}

function getLatLngData(mapurl,map) {
  // console.log(lat+ ' : '+ lng)
  // console.log(map)
  var latlan = parsePosition(mapurl)
    accorDisplay(latlan);
  /*$.ajax({
            type: 'GET',
            //data: newVendor,
